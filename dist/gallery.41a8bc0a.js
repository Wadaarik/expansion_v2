...
var _minimasonry = require("minimasonry");
var _minimasonryDefault = parcelHelpers.interopDefault(_minimasonry);
var masonry2 = new (0, _minimasonryDefault.default)({
    container: document.querySelector(".container_2"),
    gutterX: 40,
    gutterY: 40,
    baseWidth: 425
});
var masonry3 = new (0, _minimasonryDefault.default)({
    container: document.querySelector(".container_3"),
    gutterX: 40,
    gutterY: 40,
    baseWidth: 425
});
var masonry4 = new (0, _minimasonryDefault.default)({
...
},{"minimasonry":"aP4Ib","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aP4Ib":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>MiniMasonry);
...
MiniMasonry.prototype.init = function(conf) {
    for(var i in this.conf)if (conf[i] != undefined) this.conf[i] = conf[i];
...
MiniMasonry.prototype.reset = function() {
    ...
    if (this.getCount() == 1) {
        ...
        this._count = 1;
    } else if (this._width < this.conf.baseWidth + 2 * this._currentGutterX) // Remove gutter when screen is to low
    this._currentGutterX = 0;
    else this._currentGutterX = this.conf.gutterX;
};
MiniMasonry.prototype.getCount = function() {
    if (this.conf.surroundingGutter) return Math.floor((this._width - this._currentGutterX) / (this.conf.baseWidth + this._currentGutterX));
...
MiniMasonry.prototype.computeWidth = function() {
    var width;
    if (this.conf.surroundingGutter) width = (this._width - this._currentGutterX) / this._count - this._currentGutterX;
    else width = (this._width + this._currentGutterX) / this._count - this._currentGutterX;
...
MiniMasonry.prototype.layout = function() {
    ...
    for(var i = 0; i < this._count; i++)this._columns[i] = 0;
    ...
    var startX;
    if (this.conf.direction == "ltr") startX = this.conf.surroundingGutter ? this._currentGutterX : 0;
    else startX = this._width - (this.conf.surroundingGutter ? this._currentGutterX : 0);
    if (this._count > this._sizes.length) {
        ...
        if (this.conf.wedge === false) {
            if (this.conf.direction == "ltr") startX = (this._width - occupiedSpace) / 2;
            else startX = this._width - (this._width - occupiedSpace) / 2;
        } else {
            if (this.conf.direction == "ltr") ;
            else startX = this._width - this._currentGutterX;
        }
    }
    ...
    for(var index = 0; index < children.length; index++){
        ...
        if (this.conf.surroundingGutter || nextColumn != this._columns.length) childrenGutter = this._currentGutterX;
        var x;
        if (this.conf.direction == "ltr") x = startX + (colWidth + childrenGutter) * nextColumn;
        else x = startX - (colWidth + childrenGutter) * nextColumn - colWidth;
...
MiniMasonry.prototype.getShortest = function() {
    var shortest = 0;
    for(var i = 0; i < this._count; i++)if (this._columns[i] < this._columns[shortest]) shortest = i;
    return shortest;
};
MiniMasonry.prototype.getLongest = function() {
    var longest = 0;
    for(var i = 0; i < this._count; i++)if (this._columns[i] > this._columns[longest]) longest = i;
    return longest;
};
MiniMasonry.prototype.resizeThrottler = function() {
    // ignore resize events as long as an actualResizeHandler execution is in the queue
    if (!this._resizeTimeout) this._resizeTimeout = setTimeout((function() {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["5mgDX","iXSQ6"], "iXSQ6", "parcelRequire19b5")
